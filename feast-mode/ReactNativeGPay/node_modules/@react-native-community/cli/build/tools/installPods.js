  ...
  try {
    ...
    try {
      ...
      if (shouldInstallCocoaPods) {
        ...
        try {
          loader.start(`Updating CocoaPods repositories ${_chalk().default.dim('(this make take a few minutes)')}`);
    ...
    try {
      loader.succeed();
      loader.start(`Installing CocoaPods dependencies ${_chalk().default.dim('(this make take a few minutes)')}`);
